...
2. Ensure dependency snippets in `README.md`, `README.zh.md`, `ktx/README.md`, and `ktx/README.zh.md` use the `$version` placeholder.
...
2. CI will:
   - verify the changelog and README versions,
